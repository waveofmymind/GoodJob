package com.goodjob.mentoring.domain.chat.repository;
...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long> {
    ...
    @Query("SELECT cr FROM ChatRoom cr JOIN FETCH cr.sender crs JOIN FETCH cr.receiver crr WHERE (crr.username = :username AND cr.isDeleted = false) OR crs.username = :username ORDER BY cr.id desc")
