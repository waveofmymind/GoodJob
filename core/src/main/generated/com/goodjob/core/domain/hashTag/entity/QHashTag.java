package com.goodjob.core.domain.hashTag.entity;
...
public class QHashTag extends EntityPathBase<HashTag> {
    ...
    private static final long serialVersionUID = -657489223L;
    ...
    public final com.goodjob.core.domain.keyword.entity.QKeyword keyword;
    ...
    public QHashTag(Class<? extends HashTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.keyword = inits.isInitialized("keyword") ? new com.goodjob.core.domain.keyword.entity.QKeyword(forProperty("keyword")) : null;
    }
